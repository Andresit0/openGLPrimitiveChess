...
RM = /bin/rm -f
all: prac
prac: prac.o shaders.o shaders.h geometry3.h
	$(CC) $(CFLAGS) -o prac shaders.o prac.o $(INCFLAGS) $(LDFLAGS) 
prac.o: prac.cpp shaders.h geometry3.h
	$(CC) $(CFLAGS) $(INCFLAGS) -c prac.cpp 
